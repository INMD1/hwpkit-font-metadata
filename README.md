...
npm ci
node ./bin/hwpkit-font-meta.mjs --help
```
...
```bash
node ./bin/hwpkit-font-meta.mjs analyze \
...
```bash
node ./bin/hwpkit-font-meta.mjs compare \
...
```bash
node ./bin/hwpkit-font-meta.mjs analyze ./fonts \
...
```bash
node ./bin/hwpkit-font-meta.mjs analyze "/opt/company fonts/본문체.otf" -o catalog.json
```
...
```bash
node ./bin/hwpkit-font-meta.mjs analyze ./fonts/본문체.ttf -o ./font-catalog.json
